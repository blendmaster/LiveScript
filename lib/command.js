...
var argv, LiveScript, path, fs, util, preludeLs, $args, o, that, filename, join$ = [].join;
argv = process.argv;
...
function compileScript(filename, input, base){
  ...
  try {
    ...
    if (o.compile && !o.print) {
      t.output = "// Generated by LiveScript " + LiveScript.VERSION + "\n" + t.output;
    }
    if (json || o.run) {
...
function help(){
  return "Usage: lsc [options] [files] [arguments]\n\nOptions:\n" + o;
}
function version(){
