...
exports.Chain = Chain = (function(superclass){
  ...
  prototype.expandSplat = function(o){
    var tails, i, call, args, ctx, seen, i$, len$, node, cachedTails, ref$;
    tails = (this).tails;
    i = -1;
    while (call = tails[++i]) {
      if (!call.args) {
      ...
      args = Splat.expandArray(args, true);
      if (call['new']) {
        this.splattedNewArgs = List.compile(o, args);
      } else {
        ...
        call.method = '.apply';
        call.args = [ctx || Literal('null')].concat(slice$.call(args));
      }
    }
  };
...
exports.Binary = Binary = (function(superclass){
  ...
  prototype.compileRepeat = function(o){
    ...
    arr = x.isArray() && 'Array';
    if (that = items && Splat.compileArray(o, items, false)) {
      x = JS(that);
      items = null;
    }
...
exports.Splat = Splat = (function(superclass){
  ...
  Splat.expandArray = function(list, apply){
    var index, i$, len$, node, args, atoms, ref$, head, x$, c;
    expand(list);
    index = 0;
